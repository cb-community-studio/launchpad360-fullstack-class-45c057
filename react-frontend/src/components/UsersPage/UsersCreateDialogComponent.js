...
const UsersCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            ...
            isStaff: _entity.isStaff,
            isCustomer: _entity.isCustomer,
        ...
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="users-create-dialog-component">
                ...
                <div>
                    ...
                    <Checkbox checked={_entity?.isStaff} onChange={ (e) => setValByKey("isStaff", e.checked)}  ></Checkbox>
                </div>
                <div>
                    <p className="m-0" >Customer?:</p>
                    <Checkbox checked={_entity?.isCustomer} onChange={ (e) => setValByKey("isCustomer", e.checked)}  ></Checkbox>
                </div>
                <div>

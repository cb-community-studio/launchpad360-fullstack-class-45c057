...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.userId}</p>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="isStaff" header="Staff?"  sortable style={{ minWidth: "8rem" }} />
            <Column field="isCustomer" header="Customer?"  sortable style={{ minWidth: "8rem" }} />
            <Column field="userId" header="userId" body={pTemplate5} style={{ minWidth: "8rem" }} />
